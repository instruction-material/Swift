...
struct ContentView: View {
        ...
        NavigationStack {
            ScrollView {
                VStack(alignment: .leading, spacing: 28) {
                    ...
                    Text(
                        "A creative optional pack for circles, rectangles, ellipses, arcs, and layered shape composition."
                    )
                            ...
                            Rectangle()
                                ...
                                .overlay(
                                    RoundedRectangle(cornerRadius: 8)
                                        .stroke(
                                            .yellow.opacity(0.45), lineWidth: 2)
                                )
                        }
                    ...
                    GroupBox("Arc and Pie Practice") {
                        VStack(alignment: .leading, spacing: 16) {
                            ZStack {
                                ForEach(
                                    Array(slices.enumerated()), id: \.offset
                                ) { _, slice in
    ...
    private func angleRange(for target: ShapeSlice) -> (
