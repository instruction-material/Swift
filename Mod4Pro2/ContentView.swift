    ...
    var body: some View {
        ZStack {
            Path { path in
                ...
                path.addArc(
                    center: .init(x: 187, y: 187), radius: 150,
                    startAngle: Angle(degrees: 0.0),
                    endAngle: Angle(degrees: 250), clockwise: true)
            ...
            Path { path in
                ...
                path.addArc(
                    ...
                    endAngle: Angle(degrees: 190), clockwise: true)
            ...
            .stroke(
                Color(red: 52 / 255, green: 52 / 255, blue: 122 / 255),
                lineWidth: 10
            )
            .offset(x: -20, y: -17)
            .overlay(
            ...
            Path { path in
                ...
                path.addArc(
                    ...
                    endAngle: Angle(degrees: 140), clockwise: true)
