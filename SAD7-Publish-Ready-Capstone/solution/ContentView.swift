                ...
                ScrollView {
                    VStack(alignment: .leading, spacing: 20) {
                        VStack(alignment: .leading, spacing: 8) {
                            ...
                            Text(
                                "A small but ship-minded shell that keeps design, polish, and release tasks visible."
                            )
            ...
            NavigationStack {
                List {
                    ...
                    Section("Testing Focus") {
                        Text(
                            "Verify navigation, dynamic type, button labels, and launch state."
                        )
                    }
                }
            ...
            NavigationStack {
                List {
                    ...
                    Section("Accessibility") {
                        Label(
                            "Primary actions use clear labels",
                            systemImage: "figure.wave")
                        Label(
                            "Contrast checked for large text",
