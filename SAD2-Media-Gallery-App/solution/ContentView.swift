...
struct ContentView: View {
    private let artworks = [
        Artwork(
            title: "Sunset Poster", category: "Photo", accent: .orange,
            summary: "A warm poster-style sunset composition.",
            detail:
                "Practice big image blocks, text hierarchy, and category tagging."
        ),
        Artwork(
            title: "Studio Desk", category: "Workspace", accent: .blue,
            summary: "A clean desk setup for editing and sketching.",
            detail:
                "This entry works well for discussing composition and app branding."
        ),
        Artwork(
            title: "Night Walk", category: "Photo", accent: .purple,
            summary: "City lights and motion blur after dark.",
            detail:
                "Use this card to compare subtle and high-contrast color palettes."
        ),
        Artwork(
            title: "Sketchbook", category: "Illustration", accent: .pink,
            summary: "A spread of thumbnail drawings.",
            detail:
                "This entry is a good excuse to discuss repeated layouts and reusable cards."
        ),
    ]
