# SAD5 App Store Connect and TestFlight Workflow supplemental 2

Course: Intro to Swift App Development
Module: SAD5 App Store Connect and TestFlight Workflow supplemental 2
...
Quick run hint: `swift App.swift`
