            ...
            ScrollView {
                VStack(alignment: .leading, spacing: 20) {
                    VStack(alignment: .leading, spacing: 8) {
                        ...
                        Text(
                            "Build your first SwiftUI app by turning a simple profile into a real app screen."
                        )
                    ...
                    VStack(alignment: .leading, spacing: 12) {
                        ...
                        Text(
                            "3. Improve the destination page so it feels finished."
                        )
                    }
...
struct ProfileDetailView: View {
    ...
    var body: some View {
        List {
            Section("About") {
                Text(
                    "\(profile.name) is learning how to build apps with SwiftUI."
                )
            ...
            Section("Next Step") {
                Text(
                    "TODO: Add a favorite tools section and a more polished layout."
                )
            }
        }
