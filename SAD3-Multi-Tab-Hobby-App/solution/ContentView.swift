...
struct ContentView: View {
    private let activities = [
        HobbyActivity(
            title: "Photo Walk", day: "Tuesday", icon: "camera",
            summary: "Scout a neighborhood and collect strong compositions."),
        HobbyActivity(
            title: "Sketch Session", day: "Thursday", icon: "pencil",
            summary: "Turn references into quick concept sketches."),
        HobbyActivity(
            title: "Community Meetup", day: "Saturday", icon: "person.3",
            summary: "Share work, feedback, and next-week ideas."),
    ]
